...
export const Login = ({editModalContent, closeFunc}) => {
    ...
    const setForgotPassword = () => {
        editModalContent('forgotPassword')
    }
    ...
    return (
        <div className={style.form}>
                ...
                <Form style={{marginTop: "-17"}}>
                    ...
                    <div className="mg-b-20">
                        <div className="float_left" style={{ textAlign: "left" }}>
                            ...
                            <span className="input-link font-size-10 float_right" onClick={()=> setForgotPassword()}>Forgot password?</span>
                        </div>
                    </div>
            ...
            <div className="text_center">
                ...
                <p className="color_grey size_12">Don’t have Account? <span onClick={()=> alert('test')}>Sign up</span></p>
            </div>
        </div>
    )
}
